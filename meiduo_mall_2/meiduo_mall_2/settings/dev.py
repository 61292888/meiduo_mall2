"""
Django settings for meiduo_mall_2 project.
...
SECRET_KEY = '&cae-0khaoeqo+uqmo4j5=^8lpg7s&4czn^+&ji_lqyuc!8n+0'
...
ROOT_URLCONF = 'meiduo_mall_2.urls'
...
WSGI_APPLICATION = 'meiduo_mall_2.wsgi.application'
